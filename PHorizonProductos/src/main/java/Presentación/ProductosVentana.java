...
public class ProductosVentana extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Inserción de Producto");
        ...
        jLabel5.setText("Mostrar un producto");
        ...
        jLabel7.setText("Modificar un producto");

        jLabel8.setText("Nombre del producto a editar");
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        Boolean resultado = h.create(nombre, tipo, cantidad);
        if (resultado) 
            JOptionPane.showMessageDialog(null, "Producto añadido.");
        else 
            JOptionPane.showMessageDialog(null, "Error. Intente más tarde.");
    }//GEN-LAST:event_jButton1ActionPerformed

    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        String nombreBusq = jTextField4.getText();
        Handler h = new Handler();
        String respuesta = h.search(nombreBusq);
        if (respuesta != null)
    ...
    private void jButton3ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton3ActionPerformed
        String nombreMod = jTextField5.getText();
        String newNombre = jTextField6.getText();
        String newTipo = jTextField7.getText();
        int newCantidad = Integer.parseInt(jTextField8.getText());
        Handler h = new Handler();
        boolean recibo = h.mod(nombreMod, newNombre, newTipo, newCantidad);
        if (recibo)
